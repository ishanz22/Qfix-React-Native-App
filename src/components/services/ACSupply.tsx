...
const ACSupply = () => {
  ...
  return (
    ...
    contentContainerStyle={{ flexGrow: 1, alignItems: 'center', backgroundColor: "#3D4147", paddingHorizontal: 16 }}>
      ...
      <View style={styles.descriptionContainer}>
        <Text style={styles.description}>
          {expanded ? descriptionText : descriptionText.slice(0, 250) + '... '}
          {expanded ? (
      ...
      <Text style={styles.details}>For AC supply services, it is hard to beat the quality and reliability offered by <Text style={styles.ywll}>QFIXs </Text>–  Supply.
With the many years of experience in the industry, <Text style={styles.ywll}>QFIXs </Text>– Quick Fix Technical services Supply has become a trusted name in the <Text style={styles.ywll}>HVAC </Text>–  industry. From supplying the latest AC units to providing timely service and repair, <Text style={styles.ywll}>QFIXs </Text>– - Quick Fix Technical Services Supply has it all.</Text>
