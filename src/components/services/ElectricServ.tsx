            ...
            {showServiceButtons && (
              <View style={styles.buttonContainer}>
                ...
                <View style={styles.buttonRow}>
                  <TouchableOpacity
                    onPress={() => handleServiceClick("1", 250)}
                    style={[
                      styles.button,
                      { width: buttonWidth },
                      isQuantitySet && selectedService === "1"
                        ? styles.selectedButton
                        : null,
                    ]}
                  >
                  ...
                  <TouchableOpacity
                    onPress={() => handleServiceClick("2", 250)}
                    style={[
                      styles.button,
                      { width: buttonWidth },
                      isQuantitySet && selectedService === "2"
                        ? styles.selectedButton
                        : null,
                    ]}
                  >
                  ...
                  <TouchableOpacity
                    onPress={() => handleServiceClick("3", 250)}
                    style={[
                      styles.button,
                      { width: buttonWidth },
                      isQuantitySet && selectedService === "3"
                        ? styles.selectedButton
                        : null,
                    ]}
                  >
                ...
                <View style={styles.buttonRow}>
                  <TouchableOpacity
                    onPress={() => handleServiceClick("4", 250)}
                    style={[
                      styles.button,
                      { width: buttonWidth },
                      isQuantitySet && selectedService === "4"
                        ? styles.selectedButton
                        : null,
                    ]}
                  >
