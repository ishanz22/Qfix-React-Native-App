    ...
    <ScrollView ref={scrollViewRef} showsVerticalScrollIndicator={false}>
      <View style={styles.container}>
            ...
            {showServiceButtons && (
              <View style={styles.buttonContainer}>
                ...
                <View style={styles.buttonRow}>
                  <TouchableOpacity
                    onPress={() => handleServiceClick("Clog", 250)}
                    style={[
                      styles.button,
                      { width: buttonWidth },
                      isQuantitySet && selectedService === "Clog"
                        ? styles.selectedButton
                        : null,
                    ]}
                  >
                    <Text style={styles.buttonText}>Clog</Text>
                  </TouchableOpacity>

                  <TouchableOpacity
                    onPress={() => handleServiceClick("Leak", 250)}
                    style={[
                      styles.button,
                      { width: buttonWidth },
                      isQuantitySet && selectedService === "Leak"
                        ? styles.selectedButton
                        : null,
                    ]}
                  >
                    <Text style={styles.buttonText}>Leak</Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    onPress={() => handleServiceClick("Water Heater", 250)}
                    style={[
                      styles.button,
                      { width: buttonWidth },
                      isQuantitySet && selectedService === "Water Heater"
                        ? styles.selectedButton
                        : null,
                    ]}
                  >
                    <Text style={styles.buttonText}>Water Heater</Text>
                  </TouchableOpacity>
                </View>

                <View style={styles.buttonRow}>
                  <TouchableOpacity
                    onPress={() => handleServiceClick("Hand Shower", 250)}
                    style={[
                      styles.button,
                      { width: buttonWidth },
                      isQuantitySet && selectedService === "Hand Shower"
                        ? styles.selectedButton
                        : null,
                    ]}
                  >
                    <Text style={styles.buttonText}>Hand Shower</Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    onPress={() => handleServiceClick("Pump", 250)}
                    style={[
                      styles.button,
                      { width: buttonWidth },
                      isQuantitySet && selectedService === "Pump"
                        ? styles.selectedButton
                        : null,
                    ]}
                  >
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      handleServiceClick("Other", 250)
                    }
                    style={[
                      styles.button,
                      { width: buttonWidth },
                      isQuantitySet && selectedService === "Other"
                        ? styles.selectedButton
                        : null,
                    ]}
                  >
              ...
              Selected Service: 
                      ...
                      <View style={styles.gridContainer}>
                        ...
                        <TouchableOpacity
                          ...
                          style={styles.modalButton}
                        >
                          <Text style={styles.modalButtonText}>2 Hours</Text>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity
                          ...
                          style={styles.modalButton}
                        >
                          <Text style={styles.modalButtonText}>3 Hours</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                          onPress={() => handleModalButtonClick(4)}
                          style={styles.modalButton}
                        >
                          <Text style={styles.modalButtonText}>4 Hours</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                          onPress={() => handleModalButtonClick(5)}
                          style={styles.modalButton}
                        >
                          <Text style={styles.modalButtonText}>5 Hours</Text>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity
                          ...
                          style={styles.modalButton}
                        >
                          <Text style={styles.modalButtonText}>6 Hours</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                          onPress={() => handleModalButtonClick(7)}
                          style={styles.modalButton}
                        >
                          <Text style={styles.modalButtonText}>7 Hours</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                          onPress={() => handleModalButtonClick(8)}
                          style={styles.modalButton}
                        >
                          <Text style={styles.modalButtonText}>8 Hours</Text>
                        </TouchableOpacity>
        ...
        <View style={styles.bookingDetailsBox}>
          ...
          {selectedQuantity > 0 ? (
            <View>
              <Text style={styles.bookingDetailsText}>Plumbing</Text>
              <Text style={styles.bookingDetailsTextItem}>
                {selectedService} (Hours: {selectedQuantity})
              </Text>
