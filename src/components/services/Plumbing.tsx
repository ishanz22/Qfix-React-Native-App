...
const BookButton = ({ onPress }) => {
  return (
    <TouchableOpacity style={styles.bookButton} onPress={onPress}>
      ...
      <Text style={styles.bookButtonText}>Book Plumber </Text>
      <Text>{"   "}</Text>
  ...
  return (
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Card
        ...
        onPress={() => navigation.navigate("plumbingsupply")}
      />
      <Card
        imageSource={require("../../assets/acc.webp")}
        title="Plumbing Installation"
        onPress={() => navigation.navigate("plumbinginstall")}
      />
      <Card
        imageSource={require("../../assets/csz.jpg")}
        title="Plumbing Repair"
        onPress={() => navigation.navigate("plumbingrepair")}
      />
