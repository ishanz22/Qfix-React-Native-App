    ...
    <Stack.Navigator
      ...
      screenOptions={({ route }) => ({
        ...
        header: ({ navigation }) => {
          ...
          if (route.name === 'acservice'||route.name === 'plumbing' ||route.name === 'electric' ||route.name === 'painting' ||route.name === 'handyman' ||route.name === 'carpentry' ||route.name === 'cleaning' ||route.name === 'pest') {
            headerLeftButton = (
              <TouchableOpacity
